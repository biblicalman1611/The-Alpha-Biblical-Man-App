            ...
            {isLoggedIn ? (
              <div className="pt-4 border-t border-stone-100">
                ...
                >
                 ...
                 <button
                  onClick={() => {
                    onNavigate(NavSection.ADMIN);
                    setMobileMenuOpen(false);
                  }}
                  className="w-full text-left text-sm font-medium tracking-wide uppercase py-2 px-4 text-stone-400 hover:text-stone-900"
                >
                  Admin Portal
                </button>
                <button
      ...
      <footer className="bg-stone-900 text-stone-400 py-16">
        ...
        <div className="max-w-6xl mx-auto px-6 mt-16 pt-8 border-t border-stone-800 text-xs text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4 text-stone-600">
          ...
          <div className="flex gap-6">
            <button onClick={() => onNavigate(NavSection.ADMIN)} className="hover:text-stone-400 transition-colors">Admin Entry</button>
